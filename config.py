...
# Wake Word
WAKE_WORD_MODEL_PATH="D:/tech_stuff/coding/projects/My_own_Jarvis/.venv-12/Lib/site-packages/openwakeword/resources/models/hey_jarvis_v0.1.tflite"  # To get it run /setup/download_models.py, you'll get path in the console
WAKE_BLOCK_SEC = 2 # How much context sound your model gets, 2 works pretty well for me
WAKE_TRESHOLD = 0.5 # How frequently your model checks audio, don't set too low cuz it'll eat your cpu

# Whisper transcription
WHISPER_MODEL_PATH = "D:/tech_stuff/coding/projects/My_own_Jarvis/setup/model" # To get it run /setup/download_models.py, you'll get path in the console
...
INPUT_DEVICE = None # Keep None to use system default or auto-fallback; set to device index/name to force a mic
MIC_SAMPLE_RATE_HZ = None # Keep None for auto; set to 48000 if your mic does not support 16000 directly
